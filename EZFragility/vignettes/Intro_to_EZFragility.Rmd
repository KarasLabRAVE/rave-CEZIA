...
# test patient data for consistency of soz indices and names
...
```{r visualize_frag_distribution,out.width="100%"}
time_window=c(-3,5)
data("fragm3sp5s")
sozindex<-attr(fragm3sp5s,"sozindex")
# compute fragility statistics evolution with time (mean and standard deviation) for soz and
...
```{r visualize_frag_quantile,out.width="100%"}
time_window=c(-3,5)
data("fragm3sp5s")
sozindex<-attr(fragm3sp5s,"sozindex")
# compute fragility statistics evolution with time (mean and standard deviation) for soz and
