...
## Load ictal ieeg data for patient PT01

This data corresponds to the first seizure of patient PT01 from the Fragility Data Set. The data contains only the good channels. It has been notch filtered and common average referenced in RAVE It has been epoched -10:10s around the seizure onset The acquisition frequency is 1000 Hz EcoG recording gathered in collaboration with the National Institute of Health. A Matrix with 20001 rows (time points) and 84 columns (electrodes). The columns names are the electrodes names. The row names is the time relative to seizure onset in (s)
